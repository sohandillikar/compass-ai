...
export default function Home() {
  return (
    <main className="min-h-dvh bg-gradient-to-b from-primary via-primary/95 to-primary/90">
      <div className="mx-auto flex min-h-dvh max-w-5xl flex-col px-4 py-6 sm:px-6 lg:px-10">
        <div className="flex flex-1 flex-col gap-8 lg:grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1.3fr)] lg:items-stretch">
          ...
          <section className="mt-4 flex items-stretch lg:mt-0">
            <div className="mx-auto flex w-full max-w-2xl flex-1 overflow-hidden rounded-2xl bg-background shadow-xl ring-1 ring-border/70">
              <ChatInterface />
            </div>
          </section>
        </div>
